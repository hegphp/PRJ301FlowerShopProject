            ...
            <c:set value="0" var="count"></c:set>
                ...
                <div class="row">
                    <form class="form-inline d-flex justify-content-center" action="search" method="post">
                        <input type="hidden" name="bouquetName" value="${bouquetName}">
                ...
                <c:if test="${count==0}">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-center"><a class="text-decoration-none text-primary" href="BouquetController?info=1&id=${i.getBouquetId()}">${i.getBouquetName()}</a></h5>
                                    <c:choose>

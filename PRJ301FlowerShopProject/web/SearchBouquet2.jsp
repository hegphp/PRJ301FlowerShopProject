...
//            ArrayList<Bouquet> 
        ...
        <div class="header">
            ...
            <div class="header-center">
                ...
                <form action="search" method="get">
                    <input type="text" name='bouquetName' class="searchbar" placeholder="Tìm kiếm hoa tại đây" value="${bouquetName}">
        ...
        <div id="body-webpage">
            ...
            <h1 class="bouquet-category" style="text-align: center">Kết quả tìm kiếm</h1>
            <div class="content">

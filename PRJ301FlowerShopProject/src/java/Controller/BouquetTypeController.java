...
public class BouquetTypeController extends HttpServlet {
    ...
    throws ServletException, IOException {
        try{
            ...
            request.setAttribute("bouquetType", daoType.getBouquetNameById(Integer.parseInt(request.getParameter("id"))));
            ...
            request.getRequestDispatcher("BouquetListByType2.jsp").forward(request, response);
